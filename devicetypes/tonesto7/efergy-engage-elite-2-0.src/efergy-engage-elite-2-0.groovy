...
metadata {
	...
	tiles (scale: 2) {
        multiAttributeTile(name:"power", type:"generic", width:6, height:4, wordWrap: true, canChangeIcon: true) {
    		tileAttribute("device.power", key: "PRIMARY_CONTROL") {
      			attributeState "default", label: '${currentValue} W', icon: "http://www.pvhc.net/img117/prauiuxzhrsvurpppzct.png", 
